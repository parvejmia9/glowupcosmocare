...
const tabs = [
  ...
  { key: "storefront", label: "Storefront", icon: StoreIcon },
  { key: "products", label: "Products", icon: BoxIcon },
  // { key: "testimonial", label: "Testimonials", icon: StarIcon },
  { key: "others", label: "Others", icon: CogIcon },
] as const;
...
interface Props {
  ...
  storefrontSection: ReactNode;
  productsSection: ReactNode;
  othersSection: ReactNode;
}

export default function SettingsTabs({ personalSection, storefrontSection, productsSection, othersSection }: Props) {
